...
const struct attm_desc proj_template_server_att_db[PROJ_TEMPLATE_IDX_NB] =
{
	...
	[PROJ_TEMPLATE_IDX_REVPERMINUTE_CHAR]		= { ATT_DECL_CHARACTERISTIC, PERM(RD, ENABLE), 0, 0 },
	[PROJ_TEMPLATE_IDX_REVPERMINUTE_VAL]		= { TRX_CHAR_REVPERMINUTE_UUID, PERM(RD, ENABLE) | PERM(WRITE_COMMAND, ENABLE), PERM(RI, ENABLE), PROJ_TEMPLATE_SERVER_PACKET_SIZE },
