...
enum
{
	...
	TRX_CHAR_VBATT_UUID				= 0xFFF2,
	TRX_CHAR_REVPERMINUTE_UUID		= 0xFFF3,
	TRX_CHAR_S2C_UUID				= 0xFFF4,
	TRX_CHAR_C2S_UUID				= 0xFFF5,
};
...
enum
{
	...
	PROJ_TEMPLATE_IDX_REVPERMINUTE_CHAR,
	PROJ_TEMPLATE_IDX_REVPERMINUTE_VAL,
